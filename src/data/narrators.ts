// Narradores ElevenLabs en español, por región. La narración se genera contra
// el media-service (la key vive allá, nunca acá).
export type Region = 'ar' | 'lat';
export interface Narrator { slug: string; name: string; region: Region; desc: string; voiceId: string; }
